...
public class AppTest 
{
	...
	public void testForIncorrectFile() {
		try {
		if(Paths.get("src/main/resources/IndiaStateCensusData.csv")!=StateCensusAnalyzer.indianCensusDataFalseCount) {
			StateCensusException stateCensusException = new StateCensusException(Type.FileNotFound, "File is incorrect");
